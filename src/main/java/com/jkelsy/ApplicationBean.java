...
public class ApplicationBean implements Serializable {
    ...
    public void iniciar(){
        ...
        rutaFisicaArchivos = "C:"+FileSystems.getDefault().getSeparator()+"Users"+FileSystems.getDefault().getSeparator()+"Familia"+FileSystems.getDefault().getSeparator()+"Documents"+FileSystems.getDefault().getSeparator()+"desarrollo"+FileSystems.getDefault().getSeparator()+"files"+FileSystems.getDefault().getSeparator()+"formulario";
