...
public class LoginController implements Serializable {
    ...
    public String login() {
        ...
        if (valid) {            
            ...
            session.setAttribute("username", "0001");            
            //Object[] usuario = loginService.buscarPEOPLE_CODE_ID(user);
            //Object[] usuario = loginService.buscarPEOPLE_CODE_ID("0001");
            ...
            if(usuario){
                ...
                */
                ...
                session.setAttribute("PEOPLE_CODE_ID", "001");                          
                session.setAttribute("FIRST_NAME", "JESUS");
                session.setAttribute("MIDDLE_NAME", "MESTRA");
                session.setAttribute("LAST_NAME", "POLO");
